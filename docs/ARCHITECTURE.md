...
- [0029](decisions/0029-mixnet-transport-scope.md) — a mixnet transport stays out of the crate: carrying the service over one is nearly free in code, but a measured ~17% stream-establishment failure rate, seconds of latency and a dependency larger than this project put it behind a sidecar rather than a Cargo feature.
